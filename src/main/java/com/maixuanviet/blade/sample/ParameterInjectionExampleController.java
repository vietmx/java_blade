package com.maixuanviet.blade.sample;

import java.nio.file.Files;
import java.nio.file.StandardOpenOption;

import com.maixuanviet.blade.sample.vo.User;
...
public class ParameterInjectionExampleController {
    ...
    public RestResponse<?> fileParam(@MultipartParam FileItem fileItem) throws Exception {
        try {
            ...
            java.nio.file.Path tempFile = Files.createTempFile("maixuanviet_tempfiles", ".tmp");
